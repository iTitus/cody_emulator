...
pub trait Memory {
    ...
    fn read_u8_zp(&mut self, address: u16) -> u8 {
        self.read_u8(address & 0xFF)
    }
    ...
    fn read_u16_zp(&mut self, address: u16) -> u16 {
    ...
    fn write_u8_zp(&mut self, address: u16, value: u8) {
        self.write_u8(address & 0xFF, value)
    }
    ...
    fn write_u16_zp(&mut self, address: u16, value: u16) {
        let [l, h] = value.to_le_bytes();
